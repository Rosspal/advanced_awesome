defmodule AdvancedAwesomeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AdvancedAwesomeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AdvancedAwesomeWeb.Gettext, "errors", msg, opts)
    # end
